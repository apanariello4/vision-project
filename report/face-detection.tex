...
In case \ref*{Eyes found}, if the face is found with its eyes, we assume that the person is facing the camera and there is no painting behind it, like in fig. \ref{fig:Eyes}.
\begin{figure}
    \centering
...
Looking better, however, we saw that by computing the recall and precision as:
\[Precision = \frac{14}{14+10} \approx 0.58\]
\[Recall = \frac{14}{14+13} \approx 0.52\]
...
\begin{table}[]
    ...
    \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{\textbf{True}} & \multicolumn{1}{c|}{\cellcolor[HTML]{34FF34}14} & \multicolumn{1}{c|}{\cellcolor[HTML]{FE0000}10} \\ \cline{2-4} 
    \multicolumn{1}{c|}{\multirow{-2}{*}{\textit{\begin{tabular}[c]{@{}c@{}}Face detector\\ answer\end{tabular}}}} &
      \multicolumn{1}{c|}{\textbf{False}} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{FE0000}13} &
      \multicolumn{1}{c|}{\cellcolor[HTML]{34FF34}57} \\ \cline{2-4} 
    \end{tabular}%
