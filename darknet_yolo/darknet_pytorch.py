...
class Darknet(nn.Module):
    ...
    def yolo_detection(self, frame, show=False):
        '''
        :param frame: the frame in which to perform the detection
        :return: the detections list with this format (class_id, score, left, top, right, bottom, color), where
        ...
        detections_list = detect.bounding_box_yolo(
            frame, self.img_size, self, draw_rois=True)
        end = time.time()
        print(
